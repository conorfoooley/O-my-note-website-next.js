...
import { updateUserProfilePhoto, getUserProfile } from "../actions/auth";
...
class Profile extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log("this is user props",this.props.user);
    }
    ...
    render() {
        return (
            <>
                <ProductHeader profileImage={this.state.imageUrl} />
                                        ...
                                        <div>
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    if (
                                                        formDataImage.keys().next()
                                                            .value
                                                    ) {
                                                        this.props.updateUserProfilePhotoFn(
                                                            formDataImage,
                                                            this.props.ctx
                                                                .token,
                                                            () => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        updateUserProfilePhotoFn: (data, token, fn) =>
            dispatch(updateUserProfilePhoto(data, token, fn)),
    };
};
