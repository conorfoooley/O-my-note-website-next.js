...
class Search extends PureComponent {
    ...
    componentDidMount() {
        ...
        this.props.getNotes(0, 20, this.props.ctx.token, (res) => { res ? this.setState({ notes: res }) : null })
        this.props.getPerfumes(0, 20, this.props.ctx.token, (res) => { res ? this.setState({ perfumes: res }) : null })
        this.props.getBrands(0, 20, this.props.ctx.token, (res) => { res ? this.setState({ brands: res }) : null })
    }
    ...
    render() {
        const { notes, perfumes, brands, items, searchActive, searchTerm } = this.state
        ...
        return (
            <div >
                ...
                {!searchActive ?
                    <>
                        <div className='client-list-header' style={{ paddingTop: '25%' }}>
                            <h2 className='client-list-title'>Note - Top Searched</h2>
                            <Separator />
                            <Button
                                onClick={() => { Router.push('/search/note') }}
                                type='link'
                                htmlType="submit"
                                style={{
                                    color: "#1d1e1e",
                        ...
                        <div className='client-list-header'>
                            <h2 className='client-list-title'>Perfume - Top Searched</h2>
                            <Separator />
                            <Button
                                onClick={() => { Router.push('/search/perfume') }}
                                type='link'
                                htmlType="submit"
                                style={{
                                    color: "#1d1e1e",
                        ...
                        <div className='client-list-header'>
                            <h2 className='client-list-title'>Brand - Top Searched</h2>
                            <Separator />
                            <Button
                                onClick={() => { Router.push('/search/brand') }}
                                type='link'
                                htmlType="submit"
                                style={{
                                    color: "#1d1e1e",
                ...
                {searchActive ?
                    <>
                        {items.note ?
                            <><div className='client-list-header' style={{ paddingTop: '25%' }}>
                                <h2 className='client-list-title' style={{ width: '20%' }}> Notes</h2>
                                <Separator />
                                <Button
                                    onClick={() => {
                                        Router.push({
                        ...
                        {items.parfume ?
                            <><div className='client-list-header' >
                                <h2 className='client-list-title' style={{ width: '20%' }}> Perfumes</h2>
                                <Separator />
                                <Button
                                    onClick={() => {
                                        Router.push({
                                            pathname: '/search/perfume',
                                            query: { searchTerm: this.state.searchTerm }
                                        })
                                    }}
                                    type='link'
                                ...
                                <Carousel cards={items.parfume} /></> : null}
                        {items.brand ? <><div className='client-list-header' >
                            <h2 className='client-list-title' style={{ width: '20%' }}> Brands</h2>
                            <Separator />
                            <Button
                                onClick={() => {
                                    Router.push({
                            ...
                            <Carousel cards={items.brand} /></> : null}
                    </> :
                    null
                }
